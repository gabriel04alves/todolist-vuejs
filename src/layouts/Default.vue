  ...
  <v-app>
    ...
    <v-navigation-drawer app v-model="sidebar" :mini-variant.sync="mini">
      ...
      <v-list-item class="px-2" @click="mini = !mini">
        <v-list-item-avatar l>
          <v-icon>mdi-account-outline</v-icon>
        </v-list-item-avatar>
        <v-list-item-content href="/perfil">{{nome}} {{sobrenome}}</v-list-item-content>
    ...
    <v-footer app class="py-3">
      <span class="capition">TaskofDay &copy; 2022</span>
    </v-footer>
  </v-app>
</template>
...
export default {
  data(){
    return {
      ...
      mini: false,
      items: [
        {title: "Tarefas", icon: "mdi-format-list-checkbox", to: "/"},
        {title: "Perfil", icon: "mdi-account-cog-outline", to: "/perfil"},
